/*
.SYNOPSIS
    sp_WHOISACTIVE Stored Procedure Creation Scripts
.DESCRIPTION
	Creates dbo.sp_WhoIsActive Stored Procedure in DBAdmin database
	Used to find our the active processes running in the SQL Server
	Provides useful information like process start time, blocking information, CPU/Memory Usage, Wait Statistics, etc.
...
/****** Object:  StoredProcedure [dbo].[sp_WhoIsActive]    Script Date: 27/09/2023 13:27:57 ******/
SET ANSI_NULLS ON
GO
