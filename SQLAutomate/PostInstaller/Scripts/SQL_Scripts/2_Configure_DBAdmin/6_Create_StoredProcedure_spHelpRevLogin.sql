/*
.SYNOPSIS
    sp_hexadecimal Stored Procedure Creation Scripts
.DESCRIPTION
   Creates dbo.sp_hexadecimal and dbo.sp_help_revlogin stored procedure in DBAdmin database
   Used to Script out Server Logins 
.NOTES
   Source:  https://github.com/microsoft/mssql-support/blob/master/sample-scripts/security/manage-logins-permissions/sp_help_revlogin.sql   
 */
...
/****** Object:  StoredProcedure [dbo].[sp_hexadecimal]    Script Date: 10/23/2024 2:05:57 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[sp_help_revlogin]    Script Date: 10/23/2024 2:06:22 PM ******/
SET ANSI_NULLS ON
GO
