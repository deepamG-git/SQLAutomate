/*
.SYNOPSIS
    IndexOptimize Stored Procedure Creation Scripts
.DESCRIPTION
   Creates dbo.IndexOptimize stored procedure in DBAdmin database
   Used for Database Maintenance(INDEX REBUILD,REORGANIZE and UPDATE STATS)
   Output of Maintenance is stored in dbo.CommandLog table in DBAdmin database.
.NOTES
...
CREATE PROCEDURE [dbo].[IndexOptimize] AS
