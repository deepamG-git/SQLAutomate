/*
.SYNOPSIS
    CommandExecute Stored Procedure Creation Scripts
.DESCRIPTION
   Creates dbo.CommandExecute stored procedure in DBAdmin database
   Used with dbo.IndexOptimise sp for database maintenance
.NOTES
...
CREATE PROCEDURE [dbo].[CommandExecute] AS
